...
function preload() {
    ...
    // we can download such spritesheets from
    // opengameart.org 
...
function create () {
    ...
    // add tiles sprites (sprite = image)
    ...
    this.player.setCollideWorldBounds(true); // restricts inside the play zone. 
    ...
    //add a group of aaples = physical objects
    ...
    // add ouncing effect to all the apples
    ...
    //including ground to group of platforms 
    ...
    //add a inbuilt collision detection mechanism
    ...
    // this line will allow the player to kick the fruits.
...
function update () {
    ...
    if(this.cursors.up.isDown && this.player.body.touching.down) {
        this.player.setVelocity(player_config.player_jumpspeed);
    }
}
